...
def main(rank, args):
    ...
    trainset = DataFactory(
        ...
        data_root=args.data_root, setting=args.setting,
        tensor_root=os.path.join('crop_tensor', args.dataset,'image')
    )
    testset = DataFactory(
...
if __name__ == '__main__':
    ...
    # add clip
    parser.add_argument('--clip_backbone', default='ViT-L/14', choices=['RN50', 'RN50x4','RN50x16', 'ViT-B-32', 'RN101', 'ViT-B-32', 'ViT-B-16', 'ViT-L-14-336px'])

    # parser.add_argument('--clip_backbone', default='RN50x16', choices=['RN50', 'RN50x16', 'RN101', 'ViT-B-32', 'ViT-B-16'])
    parser.add_argument('--verb_loss', default=1.6, type=int)
    parser.add_argument('--clip_loss', default=400, type=int)

    # add setting params
    parser.add_argument('--setting', default='default', choices=['default', 'UA', 'rare_first',
                                                            'non_rare_first', 'uc0', 'uc1', 'uc2', 'uc3', 'uc4', 'UO'])
    parser.add_argument('--pretrain_clip', default='/mnt/bn/motor-cv-yzh/acm/checkpoints/ft_clip_vitl14/epoch19.pth', type=str)    # ./pretrained_clip/ViT-B16/image-text-adapter/best.pth
    ...
    os.environ["WANDB_API_KEY"] = 'fe7a5716372229e0694cacd97dbc4858bfc5b72c'
