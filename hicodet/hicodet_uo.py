...
from .static_hico import HOI_IDX_TO_ACT_IDX, UA_HOI_IDX, HOI_IDX_TO_OBJ_IDX, UC_HOI_IDX, UO_HOI_IDX
...
class HICODet(ImageDataset):
    ...
    def __init__(self, root: str, anno_file: str,
        ...
        # Load annotations
        is_train = False
        if 'train2015' in root:
            is_train = True

        self.uo = UO_HOI_IDX  # delete unseen verb
    ...
    def get_uc(self):
        uc = [(HOI_IDX_TO_ACT_IDX[idx], HOI_IDX_TO_OBJ_IDX[idx]) for idx in UC_HOI_IDX['uc0']]
        return uc
